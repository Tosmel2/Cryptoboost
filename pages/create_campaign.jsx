          ...
          <div className="space-y-4">
            <div className='flex flex-wrap justify-between'>
              <div className="space-y-1 md:w-[48%] w-full pb-3 md:pb-0">
                <label htmlFor="full name" className="block text-sm font-bold text-white md:p-2">Full Name*</label>
                <input type="text" name="text" placeholder="Tosmel Tungsten" className="w-full p-2  bg-transparent border rounded-3xl focus:outline-none pl-4 text-white" />
              </div>

              <div className="space-y-1 md:w-[48%] w-full">
                <label htmlFor="campaign title" className="block text-sm font-bold text-white md:p-2">Campaign Title*</label>
                <input type="text" name="text" placeholder="Write a title" className="w-full p-2 border rounded-3xl bg-transparent focus:outline-none pl-4 text-white" />
              </div>
            </div>
            ...
            <div className='flex flex-wrap justify-between'>
              <div className="space-y-1 md:w-[48%] w-full pb-3 md:pb-0">
                <label htmlFor="goal" className="block text-sm font-bold text-white md:p-2">Goal*</label>
                <input type="number" name="goal" placeholder="ETH 0.05" className="w-full p-2 border rounded-3xl bg-transparent focus:outline-none pl-4 text-white" />
              </div>

              <div className="space-y-1 md:w-[48%] w-full">
                <label htmlFor="date" className="block text-sm font-bold text-white md:p-2">End Date*</label>
                <input type="date" name="date" placeholder="dd/mm/yy" className="w-full p-2 border rounded-3xl bg-transparent focus:outline-none pl-4 text-white" />
              </div>
            </div>

            <div className="space-y-1 ">
              <label htmlFor="image" className="block text-sm font-bold text-white md:p-2">Campaign Image*</label>

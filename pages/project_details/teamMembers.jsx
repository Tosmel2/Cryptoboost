  ...
  return (
    <>
      ...
      {/* <section className='w-[90%] md:w-[85%] mx-auto py-10'>
        <div className='md:flex md:justify-center bg-[#DEF1E9] md:h-[30vh] h-full rounded-md mb-8'>
        ...
        <div className='md:flex md:justify-center bg-[#DEF1E9] md:h-[30vh]  rounded-md mb-8'>
          <div className='w-full md:w-[40%] rounded-md'>
          <Image
            src={solanaImg}
            className='object-cover h-full w-full object-center rounded-md'
      ...
      {/* <section  className='md:flex md:justify-between w-[90%] mx-auto md:p-10'>
        <div className='w-full md:w-[30%] h-[40vh] rounded-lg py-3'>
          <Image
            src={solanaImg}
            className='object-cover h-full w-full object-center rounded-md'
            quality={100}
      ...
      <section className='contactus py-10 md:w-[80%] px-3 mx-auto md:flex md:justify-between'>
        ...
        <div className='md:w-1/2 pr-8 mb-5'>

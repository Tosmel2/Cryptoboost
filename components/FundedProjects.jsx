  ...
  return (
    <>
      <main className="h-full w-full bg-[#120b29]">
        <section
          id="features"
          className="funding-projects md:py-4  w-[90%] md:w-[85%] mx-auto"
        >
          <div className="text-center text-white py-10 px-3 md:px-0">
            ...
            <p className="text-md md:text-lg">
              Enter the cryptosphere with cryptoBoost
            </p>
          ...
          <div className="projects-container flex md:justify-evenly pb-10 justify-center items-center w-full flex-wrap">
            <a
              ...
              class={`sm:px-4 py-3 sm:w-auto justify-center sm:justify-start title-font text-white font-bold inline-flex items-center leading-none ${
                selectedTab === "all"
                  ? `py-3 px-5 bg-pink-600 rounded-3xl mb-3 text-white`
                  : "border-gray-200"
              } tracking-wider`}
            >
              All Funded Projects
            ...
            <a
              ...
              className={`sm:px-4 py-3 sm:w-auto justify-center sm:justify-start title-font text-gray-400 font-bold inline-flex items-center leading-none ${
                selectedTab === "upcoming"
                  ? `py-3 px-5 bg-pink-600 rounded-3xl mb-3`
                  : "border-gray-200"
              } tracking-wider`}
            >
              Upcoming Projects
        ...
        <div className="project-card md:w-[32%] lg:w-[23%] mb-5 rounded-2xl w-full h-[70vh] border border-solid border-white">
          <div className="project-card-image relative rounded-2xl md:rounded-b-none h-1/2 w-full bg-slate-800">
            <Image
              ...
              quality={100}
            />
            <p className="rounded-3xl px-5 py-1 text-sm text-center bg-white text-amber-500 font-bold absolute bottom-2 right-3">
              Upcoming
            </p>
          </div>
          <div className="project-card-content rounded-b-xl bg-white px-2 h-1/2 w-full">
            ...
            <div class="w-full bg-gray-200 rounded-full h-4 mb-2">
              <div
                class="bg-sky-400 h-4 rounded-l-lg"
                style={{ width: "1%" }}
              ></div>
            </div>
            ...
            <div className="flex justify-between items-center pt-2">
              <p>
                <span className="font-semibold text-sm mb-1 text-black">
                  Token Sale:
                </span>{" "}
                <br />{" "}
                <span className="font-bold text-orange-700">00:07:26:00</span>
              </p>
              <div className="flex">
                ...
                <button
                  type="button"
                  className="text-center py-2 px-5 font-semibold rounded-3xl bg-pink-600 text-black"
                >
                  <a href="/project_details">View</a>
                </button>
              </div>
            </div>
          </div>
        ...
        <div className="project-card md:w-[32%] lg:w-[23%] mb-5 rounded-2xl w-full h-[70vh] border border-solid border-white">
          <div className="project-card-image relative rounded-2xl md:rounded-b-none h-1/2 w-full bg-slate-800">
            <Image
              ...
              quality={100}
            />
            <p className="rounded-3xl px-5 py-1 text-sm text-center bg-green-200 text-green-800 font-bold absolute bottom-2 right-3">
              Ongoing
            </p>
          </div>
          <div className="project-card-content rounded-b-xl bg-white px-2 h-1/2 w-full">
        ...
        <div className="project-card md:w-[32%] lg:w-[23%] mb-5 rounded-2xl w-full h-[70vh] border border-solid border-white">
          <div className="project-card-image relative rounded-2xl md:rounded-b-none h-1/2 w-full bg-slate-800">
            <Image
              ...
              quality={100}
            />
            <p className="rounded-3xl px-5 py-1 text-sm text-center bg-red-400 text-red-800 font-bold absolute bottom-2 right-3">
              Ended
            </p>
          </div>
          <div className="project-card-content rounded-b-xl bg-white px-2 h-1/2 w-full">
            ...
            <div class="w-full bg-gray-200 rounded-full h-4 mb-2">
              <div
                class="bg-sky-400 h-4 rounded-full"
                style={{ width: "100%" }}
              ></div>
            </div>
      ...
      <div className="projects-container flex md:justify-evenly justify-center items-center w-full flex-wrap">
        <div className="project-card md:w-[32%] lg:w-[23%] mb-5 rounded-2xl w-full h-[70vh] md:h-[70vh] border border-solid border-white">
          ...
          <div className="project-card-content rounded-b-xl bg-white px-2 h-1/2 w-full">
            ...
            <div className="flex justify-between items-center pt-2">
              <p>
                <span className="font-semibold text-sm mb-1">Token Sale:</span>{" "}
                <br />{" "}
                <span className="font-bold text-orange-700">00:07:26:00</span>
              </p>
              <div className="flex">
